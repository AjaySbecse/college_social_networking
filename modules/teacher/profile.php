...
$profileQuery = "SELECT * FROM teacher_details WHERE email_id = '$email_id'";
...
<body>
    <div class="main-content">
        ...
        <!-- Header -->
        <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(https://st.depositphotos.com/2208684/3193/i/600/depositphotos_31934889-stock-photo-smiling-teacher-standing-in-classroom.jpg); background-size: cover; background-position: center top;">
            <!---->
            <!-- Mask -->
            ...
            <div class="container-fluid d-flex align-items-center">
                <div class="row">
                    <div class="col-lg-7 col-md-10">
                        ...
                        <p class="text-white mt-0 mb-5">Great Pleasure to see you here, You can view or update your details here.</p>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="card-profile-stats d-flex justify-content-center mt-md-5">
                                        ...
                                        <div>
                                            <span class="heading"><?php echo $row['event_conducted'] ?></span>
                                            <span class="description">Event Conducted</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
                                                ...
                                                <input type="text" id="input-first-name" class="form-control form-control-alternative" placeholder="Faculty id" name="faculty_id" value="<?php echo $row['faculty_id'] ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group focused">
