...
$query = "SELECT * from $table_name where isaccepted = 0 && role = 'student'";
                                ...
                                <div class="col-xl-3 col-md-6">
                                    <div class="card text-white mb-4" id="color4">
                                        ...
                                        <div class="card-footer d-flex align-items-center justify-content-between">
                                            <a class="btn btn-success" href="./studentAccept.php?id=' . $row["email_id"] . '">Accept</a>
                                            <a class="btn btn-danger" href="./studentReject.php?id=' . $row["email_id"] . '">Reject</a>
                                        </div>
