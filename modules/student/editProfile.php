...
if (isset($_POST['submit'])) {
    ...
    $updateQuery = "UPDATE student_details SET user_name = '$user_name',first_name = '$first_name',last_name = '$last_name',roll_number='$roll_number',
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="input-first-name" class="form-control form-control-alternative" placeholder="Roll Number" name="roll_number" value="<?php echo $row['roll_number'] ?>" required>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group focused">
